...
#
# plt.tight_layout()
# plt.savefig('Success Rate vs squezing and displacement.svg'.format(nsqz,ncoh),format='svg',transparent=True)
# plt.savefig('Success Rate vs squezing and displacement.png'.format(nsqz,ncoh),format='png',transparent=True)
# fig.show()
# plt.pause(10)
# plt.close(fig)
#
