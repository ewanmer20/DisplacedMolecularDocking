...
samples, path, ncoh, nsqz= samples_cov_alt(Adj=Adj, alpha=alpha, target_nsqz=target_nsqz, target_ncoh=target_ncoh,nsamples=nsamples, data_directory=data_directory, loss_mode=loss_mode,hbar=2, n_subspace=nsubspace)
